...
- Contact page with WhatsApp CTA and lead form
...
For real contact-form email sending, add `RESEND_API_KEY`, `EMAIL_FROM`, and `CONTACT_RECEIVING_EMAIL` in Vercel. The inquiry is also saved in MongoDB when `MONGODB_URI` is configured.
